...
# Draw boundary lines
if all(boundary):
    cv.line(img, boundary[0], boundary[1], (0, 255, 0), 2)
    cv.line(img, boundary[1], boundary[3], (0, 255, 0), 2)
    cv.line(img, boundary[3], boundary[2], (0, 255, 0), 2)
    cv.line(img, boundary[2], boundary[0], (0, 255, 0), 2)
