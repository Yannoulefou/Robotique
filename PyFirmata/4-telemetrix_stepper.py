...
# https://github.com/MrYsLab/telemetrix/blob/master/examples/stepper_absolute.py
# https://mryslab.github.io/telemetrix/pin_modes/#set_pin_mode_stepper
...
def step_absolute(the_board):
    ...
    # motor = the_board.set_pin_mode_stepper(interface=1, pin1=PULSE_PIN, pin2=DIRECTION_PIN)
